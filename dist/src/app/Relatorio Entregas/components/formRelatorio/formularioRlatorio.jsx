...
export default function FormularioRelatorio() {
    return (<form className={"".concat(estilo.stFormRelatorio)} onSubmit={function (ev) {
            ev.preventDefault();
        }}>
      <div>
        <div className={"".concat(estilo.informsLabel)}>
        ...
        <button className={"".concat(estilo.informsButtonInitRel)}>
