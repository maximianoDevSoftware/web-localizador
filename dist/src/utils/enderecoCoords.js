...
function end4Coords(endereco) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "https://nominatim.openstreetmap.org/search.php?q=".concat(endereco, "&format=json&addressdetails=1");
                ...
                case 2:
                    ...
                    meusValores = [latitude, longitude];
                    return [2 /*return*/, meusValores];
            }
        });
    });
}
