...
var usuarioModelo_1 = require("../modules/usuarioModelo");
var mongoose_1 = __importDefault(require("mongoose"));
// Create the model instance outside the function
var dataConnectUsuarios = function () { return __awaiter(void 0, void 0, void 0, function () {
    var uri, clientOptions, conn;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                uri = "mongodb+srv://renatomaximianojr:R1FL4X6xFM9xE2aX@clusterrenato.asbtntk.mongodb.net/ecoClean?retryWrites=true&w=majority&appName=clusterRenato";
                clientOptions = {
            ...
            case 1:
                conn = _a.sent();
                return [4 /*yield*/, conn.model("usuarios", usuarioModelo_1.usuarioSchema, "usuariosSchema")];
            case 2:
                _a.sent();
...
exports.default = dataConnectUsuarios;
